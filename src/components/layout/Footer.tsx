  ...
  return (
    <footer className="footer">
      ...
      <div className="footer-grid">
        ...
        <div><span>Company</span><Link to="/company">Who we are</Link><Link to="/company">Technology ecosystem</Link><Link to="/company">Careers & BEE</Link><Link to="/insights">Insights</Link></div>
        <div><span>Experience</span><Link to="/experience">Engineering in Motion</Link><Link to="/experience/water-loss-management">Water infrastructure</Link><Link to="/experience/ethekwini-telemetry-upgrade">Telemetry at scale</Link><Link to="/experience/energy-management">Energy intelligence</Link></div>
